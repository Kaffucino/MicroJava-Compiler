...
public class ClassDeclBodyYes extends ClassDeclBody {

    private ClassConstructor ClassConstructor;
    private MethodDeclList MethodDeclList;

    public ClassDeclBodyYes (ClassConstructor ClassConstructor, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclBodyYes(\n");
