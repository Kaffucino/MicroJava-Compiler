...
public class SingleStatementDOState extends SingleStatement {

    private Do Do;
    private Statement Statement;
    private Condition Condition;

    public SingleStatementDOState (Do Do, Statement Statement, Condition Condition) {
        this.Do=Do;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleStatementDOState(\n");
